...
const LoginPage = () => {
  ...
  const [senha, setSenha] = useState(''); // Usando 'senha' para corresponder ao backend
  const { login, loading, error } = useAuth();
  
  // A lógica do tema foi removida daqui, pois o tema agora é
  // controlado globalmente pelo Layout principal da aplicação.
    ...
    <div className="login-page">
      <div className="login-panel-left">
        <div className="panel-content">
          ...
          <img src={loginIllustration} alt="Ilustração de pessoas a trabalhar" />
        </div>
      </div>
      <div className="login-panel-right">
        ...
        <div className="login-form-container">
          <form className="login-form" onSubmit={handleSubmit}>
            ...
            <div className="social-login-divider">Ou entre com:</div>
